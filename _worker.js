...
// ROI comparison (1y/3y/5y vs USD) computed server-side from CryptoCompare
// daily history. Done in the Worker so it's one cached upstream call shared by
// all visitors (avoids per-visitor CORS + keyless rate-limit failures).
